...
description: Query the same Example Company Reporting dashboard stats locally from the example-company-reporting repo. Use when the user asks for Product dashboard stats, Campaigns dashboard stats, customer journey readout data, sales/SDR/support/activation transcript dashboard stats, marketing Meta Ads stats, SEO/product funnel stats, or wants to inspect dashboard data without using the browser.
---

# Dashboard Stats

Use this skill to pull dashboard data locally from `/Users/you/Programming/example-company-reporting` using the same data-loading functions the dashboard uses.
...
```bash
cd /Users/you/Programming/example-company-reporting/apps/dashboard
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section all --format summary
```
...
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section product --format json

# Campaigns dashboard, default last 7 days
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section campaigns --format summary

# Campaigns dashboard for a custom range
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section campaigns --start-date 2026-05-01 --end-date 2026-05-07 --format json

# Save full JSON for local inspection
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section all --format json --out /tmp/dashboard-stats.json

# Force the primary database only when you explicitly need it
npx tsx /Users/you/.codex/skills/dashboard-stats/scripts/dashboard-stats.ts --section campaigns --use-primary
```
